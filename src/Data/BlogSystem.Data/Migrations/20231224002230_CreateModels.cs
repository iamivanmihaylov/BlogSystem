        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadingImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostReactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogPostReactions_BlogPosts_BlogPostId",
                        column: x => x.BlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostReactions_IsDeleted",
                table: "BlogPostReactions",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPostTags_IsDeleted",
                table: "BlogPostTags",
                column: "IsDeleted");
        }
